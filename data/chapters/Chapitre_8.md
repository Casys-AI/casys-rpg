Voici le texte formaté en utilisant le format Markdown :
...
dont vous disposerez au départ en matière d'HABILETÉ et  
...
dans la case HABILETÉ de la Feuille d'Aventure.  
...
d'HABILETÉ, d'ENDURANCE et de CHANCE changent  
...
Note : j'ai ajouté un sous-titre pour la section "Habileté, Endurance et Chance" afin de mieux structurer le texte.